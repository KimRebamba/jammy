...
<form action="/admin/expenses" method="post">
    ...
    <p>Amount: <input type="text" name="amount" value="{{ old('amount') }}"></p>
    <p>Status:
        <select name="status">
    ...
    <p>Due Date: <input type="text" name="due_date" value="{{ old('due_date') }}"></p>
    <p>Paid Date: <input type="text" name="paid_date" value="{{ old('paid_date') }}"></p>
