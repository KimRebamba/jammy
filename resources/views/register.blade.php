	...
	<form method="POST" action="/register" enctype="multipart/form-data" class="rounded-2xl border border-stone-200 bg-white shadow-lg shadow-stone-200/50 p-6 space-y-4">
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
			...
			<div>
				...
				<input type="email" name="email" value="{{ old('email') }}" class="w-full rounded-xl border border-stone-300 px-3 py-2 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20">
			</div>
		</div>
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
			...
			<div>
				...
				<input type="password" name="password_confirmation" class="w-full rounded-xl border border-stone-300 px-3 py-2 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20">
			</div>
		</div>
